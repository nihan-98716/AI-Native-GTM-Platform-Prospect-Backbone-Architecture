...
class DefaultProspectAgentTools(ProspectAgentTools):
    def __init__(self, repository: ProspectWorkflowRepository, audit_service: AuditService | None = None) -> None:
        ...
        for item in drafts:
            ids.append(
                self._repository.persist_hypothesis(
                    ...
                    metadata={"supporting_evidence": item.supporting_evidence},
        ...
        for item in drafts:
            ids.append(
                self._repository.persist_outreach_draft(
                    ...
                    metadata={"review_notes": item.review_notes},
                    generated_by_agent=generated_by_agent,
                )
            )
        return ids
